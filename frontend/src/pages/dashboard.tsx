...
const Dashboard = () => {
  ...
  const [health_records, setHealth_records] = React.useState('Loading...');
  ...
  async function loadData() {
    ...
    const fns = [setUsers, setHealth_records, setRoles, setPermissions];
    ...
    <>
      ...
      <SectionMain>
        ...
        <div className='grid grid-cols-1 gap-6 lg:grid-cols-3 mb-6'>
          ...
          {hasPermission(currentUser, 'READ_HEALTH_RECORDS') && (
