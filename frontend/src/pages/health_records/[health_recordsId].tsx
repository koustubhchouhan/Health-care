...
const EditHealth_records = () => {
  ...
  const { health_recordsId } = router.query;

  useEffect(() => {
    dispatch(fetch({ id: health_recordsId }));
  }, [health_recordsId]);
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: health_recordsId, data }));
...
EditHealth_records.getLayout = function getLayout(page: ReactElement) {
  return (
...
export default EditHealth_records;
