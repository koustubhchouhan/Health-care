            ...
            >
              ...
              >
                ...
                <ListActionsPopover
                  ...
                  onEdit={onEdit}
                  itemId={item.id}
                  pathEdit={`/health_records/health_records-edit/?id=${item.id}`}
                  pathView={`/health_records/health_records-view/?id=${item.id}`}
                  hasUpdatePermission={hasUpdatePermission}
                />
              </div>
            </CardBox>
          ))}
        {!loading && health_records.length === 0 && (
...
export default ListHealth_records;
