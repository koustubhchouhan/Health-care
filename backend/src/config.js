...
const config = {
  gcloud: {
    bucket: 'fldemo-files',
    hash: '43f4738ad99c140b44ccb435e5a15808',
  },
  bcrypt: {
    saltRounds: 12,
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'Health care <app@flatlogic.app>',
  ...
  project_uuid: '5c1b14bb-ee0a-4580-9692-16bb99c06677',
  flHost:
...
config.pexelsQuery = 'calm healthcare abstract art';
config.host =
