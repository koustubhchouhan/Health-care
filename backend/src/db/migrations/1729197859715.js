module.exports = {
  ...
  async down(queryInterface, Sequelize) {
    ...
    try {
      ...
      await queryInterface.removeColumn('health_records', 'userId', {
        transaction,
      });

      await queryInterface.removeColumn('health_records', 'age', {
        transaction,
      });

      await queryInterface.removeColumn('health_records', 'name', {
        transaction,
      });
